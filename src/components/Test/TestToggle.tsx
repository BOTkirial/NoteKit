...
const TestToggle = () => {
    ...
    return (
        <div className="test-toggle">
            ...
            <Toggle defaultValue={false} offIcon={<StopCircleIcon  color="red" />} onIcon={<CheckIcon color="green" />} onColor="green" label="With icon"/>
            <Toggle defaultValue={true} disabled offIcon={<StopCircleIcon  color="red" />} onIcon={<CheckIcon color="green" />} onColor="green" label="With icon"/>
        </div>
    )
