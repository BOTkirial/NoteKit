...
import runActions from "./action.seed";
import runUsers from "./user.seed";
import runLevelOfPermissions from "./levelOfPermission.seed";
import runRoles from "./role.seed";
import runAccesMatrix from "./accessMatrix.seed.";
import runUserRoles from "./roleUser.seed";
